...
loaded_model_monture_gb = joblib.load('model_monture_72/monture_gb_model.pkl')
# Load the label encoder dictionary
le_dict = joblib.load('model_monture_72/le_dict.pkl')
loaded_model_materiaux=joblib.load('model_monture_72/materiaux_model.pkl')
